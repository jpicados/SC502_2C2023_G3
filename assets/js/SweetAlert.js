...
(function (global, factory) {
  ...
  `;
    ...
    var sweetHTML = ``;
    const button2=document.querySelector(".button_search");
    const button3=document.querySelector("#newActivoButton");
    const button4=document.querySelector("#saveButton");
    ...
    button5.addEventListener("click", () => {
      ...
      <div aria-labelledby="${swalClasses.title}" aria-describedby="${swalClasses['html-container']}" class="${swalClasses.popup}" tabindex="-1">
        ...
        <div class="box_display">
           ...
           <div class="swal2-icon swal2-success swal2-icon-show" style="display:grid; place-items:center;">
      ...
      `.replace(/(^|\n)\s*/g, '');
       ...
       <div aria-labelledby="${swalClasses.title}" aria-describedby="${swalClasses['html-container']}" class="${swalClasses.popup}" tabindex="-1">
         ...
         <div class="box_display">
            ...
            <div class="swal2-icon swal2-success swal2-icon-show" style="display:grid; place-items:center; animation:swal2-animate-error-icon .5s; ">
              <div class="swal2-success-circular-line-left"></div>

               <span class="swal2-success-line-long" style="transform: rotate(45deg);
               width: 1.55em!important; animation: swal2-toast-animate-success-line-long .0s; }"></span>
              <span class="swal2-success-line-long" style="transform: rotate(-45deg);
              width: 1.55em!important; animation: swal2-toast-animate-success-line-long .0s;}"></span>
